...
void Robot::RobotInit() {
	...
	positionLoad = positionUp + 0.0250;
...
*/
	...
	void Robot::AutonomousInit() {
		AutoTimer->Reset();
		AutoTimer->Start();
		/* Set the pointer for the autonomous program based on the dashboard value
		//autonMode = SmartDashboard::GetNumber("Select Mode", 1;
		switch(autonMode){
		case 1:
